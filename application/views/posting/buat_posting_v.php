	...
	<div class="box">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12">
            <form role="form" class="" id="form-buat-posting" method="post" action="<?= base_url('posting/simpan') ?>">
              ...
              <div class="form-group">
                ...
                <textarea name="konten" class="form-control" rows="9"></textarea>
              </div>
